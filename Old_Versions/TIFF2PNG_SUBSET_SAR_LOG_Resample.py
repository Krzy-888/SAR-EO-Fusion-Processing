...
#   DATASET
paths = [r"ORG_Data/CAPELLA_C05_URRC_SUB.tif",r"ORG_Data/CAPELLA_C06_UIAA_SUB.tif",r"ORG_Data/CAPELLA_C09_URWH_SUB.tif",r"ORG_Data/CAPELLA_C11_UDYE_SUB.tif",r"ORG_Data/IMG_PNEO3_UDYE_SUB.tif",r"ORG_Data/IMG_PNEO4_UIAA_SUB.tif",r"ORG_Data/IMG_PNEO4_URRC_SUB.tif",r"ORG_Data/IMG_PNEO4_URWH_SUB.tif"]
names = [10,1,"035"]
    ...
    with rasterio.open(path) as src:
        for j,f in enumerate(factors):
            ...
            if len(img) == 3:
                ...
                out_g = f"Norm\\{name2}_gray.png"
                out_l = f"Norm\\{name2}_log.png"
                out_b = f"Norm\\{name2}_bad.png"
